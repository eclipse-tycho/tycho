 ...
 * included in the project. This is meant to work with custom timestamp providers and generate build
 * qualifier based on build contents, i.e. the source code, and not the time the build was started.
 * 
