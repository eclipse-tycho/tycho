...
public class DefaultEquinoxInstallationFactoryTest {
    ...
    public void testBundleStartLevelsWithDefaultStartLevel() throws IOException {
        ...
        Assert.assertTrue(osgiBundles.contains("reference:file:absolute/path/to/bundle1@6:start")); // contains the setted level
        Assert.assertTrue(osgiBundles.contains("reference:file:absolute/path/to/bundle2@7:start")); // contains the default level
    }
    ...
    public void testBundleStartLevelsWithoutDefaultStartLevel() throws IOException {
        ...
        Assert.assertTrue(osgiBundles.contains("reference:file:absolute/path/to/bundle1@6:start")); // contains the setted
        Assert.assertTrue(osgiBundles.contains("reference:file:absolute/path/to/bundle2")); // contains the bundle
        Assert.assertFalse(osgiBundles.contains("reference:file:absolute/path/to/bundle2@")); // does not contain any start level
    }
}
