...
public class MutableBundleManifestTest {
    ...
    @Test
    public void setRequireBundleVersions() throws IOException {
        MutableBundleManifest mf = getManifest("/manifests/setRequiredBundleVersions.mf");
        mf.setRequiredBundleVersion("bundle1", "1.0.1");
        mf.setRequiredBundleVersion("bundle2", "1.1.1");
        assertContents(mf, "/manifests/setRequiredBundleVersions.mf_expected");
    }
