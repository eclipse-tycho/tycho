...
public interface MirrorApplicationService {
    ...
    /**
     * performs xz compression for the given DestinationRepositoryDescriptor
     * 
     * @param destination
     *            The p2 repository that shall be compressed. The location must be a directory.
     * @throws FacadeException
     *             if a checked exception occurs while compression
     */
