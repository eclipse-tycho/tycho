...
public class ReactorProjectMock implements ReactorProject, ReactorProjectIdentities {
    ...
    public ReactorProjectMock(File basedir, String groupId, String artifactId, String version, String packagingType) {
