...
public class StubServiceRegistration<T> extends ExternalResource {
    ...
    private void internalRegisterService() {
        ...
        serviceRegistration = org.eclipse.tycho.p2.impl.Activator.getContext().registerService(type, instance, null);
    }
    ...
    protected void after() {
        if (serviceRegistration != null) {
            ...
            System.out.println("Warning: " + classNameWithGenericParameter
