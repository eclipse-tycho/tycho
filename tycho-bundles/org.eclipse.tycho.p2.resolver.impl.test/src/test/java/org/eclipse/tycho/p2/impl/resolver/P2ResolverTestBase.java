...
public class P2ResolverTestBase {
    ...
    protected final PomDependencyCollectorImpl createPomDependencyCollector() throws Exception {
        return resolverFactory.newPomDependencyCollectorImpl();
    }

    protected final TargetPlatformFactoryImpl createTargetPlatformFactory() throws Exception {
        return resolverFactory.getTargetPlatformFactoryImpl();
    }
}
