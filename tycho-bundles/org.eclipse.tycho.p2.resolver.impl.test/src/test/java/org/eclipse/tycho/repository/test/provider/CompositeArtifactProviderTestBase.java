...
import static org.eclipse.tycho.repository.test.TestRepositoryContent.NOT_CONTAINED_ARTIFACT_KEY;
import static org.eclipse.tycho.repository.test.TestRepositoryContent.REPO_BUNDLE_A;
...
import static org.eclipse.tycho.testutil.ArtifactRepositoryTestUtils.inCanonicalFormat;
...
import static org.eclipse.tycho.testutil.StatusMatchers.okStatus;
import static org.eclipse.tycho.testutil.StatusMatchers.statusWithMessageWhich;
...
import org.eclipse.tycho.p2.artifact.provider.streaming.ArtifactSinkFactory;
...
import org.eclipse.tycho.repository.test.local.NonStartableArtifactSink;
