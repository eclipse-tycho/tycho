 ...
 * </p>
 */
public final class PublishedBundlesArtifactRepository extends ArtifactRepositoryBaseImpl<GAVArtifactDescriptor> {

    public PublishedBundlesArtifactRepository(File localMavenRepositoryRoot) {
