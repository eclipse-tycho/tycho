...
public class InstallableUnitResolver implements Resolvable {
    ...
    private List<LoadedIULocation> loadedIULocations = new ArrayList<>();
    ...
    public void addLocation(InstallableUnitLocation iuLocationDefinition)
        ...
        loadedIULocations.add(loadedLocation);
        rootIUs.addAll(loadedLocation.getRootIUs());

        availableUnitSources.addAll(loadedLocation.getAvailableUnits());
    }

    public List<IMetadataRepository> getLoadedIULocations() {
        ArrayList<IMetadataRepository> list = new ArrayList<>();
        for (LoadedIULocation loadedIULocation : loadedIULocations) {
            list.addAll(loadedIULocation.loadedRepositories);
        }
        return list;
    }
    ...
    private class LoadedIULocation {
        ...
        private final InstallableUnitLocation locationDefinition;
        private final List<IMetadataRepository> loadedRepositories = new ArrayList<>();
