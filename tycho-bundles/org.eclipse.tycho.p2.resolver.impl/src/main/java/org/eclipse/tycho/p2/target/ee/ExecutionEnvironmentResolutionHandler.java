...
//        }
    ...
    /**
     * Factory method for tests. Creates an {@link ExecutionEnvironmentResolutionHandler} instance
     * ignoring call-backs.
     */
    public static ExecutionEnvironmentResolutionHandler adapt(ExecutionEnvironmentResolutionHints eeHints) {
        return new StandardEEResolutionHandler(eeHints);
    }

    private final ExecutionEnvironmentResolutionHints resolutionHints;

    ExecutionEnvironmentResolutionHandler(ExecutionEnvironmentResolutionHints resolutionHints) {
