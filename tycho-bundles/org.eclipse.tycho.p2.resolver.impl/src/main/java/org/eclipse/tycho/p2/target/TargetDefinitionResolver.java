...
public final class TargetDefinitionResolver {
    ...
    public TargetDefinitionContent resolveContent(TargetDefinition definition, IncludeSourceMode includeSourcesMode) {
        try {
    ...
    public TargetDefinitionContent resolveContent(TargetDefinition definition) {
        return resolveContent(definition, IncludeSourceMode.honor);
    }
    ...
    TargetDefinitionContent resolveContentWithExceptions(TargetDefinition definition,
            IncludeSourceMode includeSourcesMode) throws TargetDefinitionSyntaxException,
        ...
        for (Location locationDefinition : definition.getLocations()) {
            if (locationDefinition instanceof InstallableUnitLocation) {
                ...
                if (includeSourcesMode == IncludeSourceMode.ignore) {
                    includeSources = false;
                } else if (includeSourcesMode == IncludeSourceMode.force) {
                    includeSources = true;
                }
    ...
    TargetDefinitionContent resolveContentWithExceptions(TargetDefinition definition)
        ...
        return resolveContentWithExceptions(definition, IncludeSourceMode.honor);
    }
