...
public class MirroringArtifactProviderTest {
    ...
    // TODO set up a test which uses a Jetty
    @Ignore("This test fails. The normally visible log output is generated by ECF, which is not used for file repositories")
    @Test
