...
public final class TestRepositoryContent {
    ...
    public static final String BUNDLE_A_CANONICAL_MD5 = "58057045158895009b845b9a93f3eb6e";
    public static final String BUNDLE_B_PACKED_MD5 = "d827085062b9cceff5401db6eb2e5860";

    public static final Set<String> BUNDLE_A_FILES = new HashSet<String>(Arrays.asList(new String[] {
            "about_files/", "META-INF/", "META-INF/MANIFEST.MF", "org/", "org/eclipse/", "org/eclipse/core/",
    ...
    public static final Set<String> BUNDLE_B_FILES = new HashSet<String>(Arrays.asList(new String[] {
            "META-INF/", "META-INF/eclipse.inf", "META-INF/MANIFEST.MF" }));
