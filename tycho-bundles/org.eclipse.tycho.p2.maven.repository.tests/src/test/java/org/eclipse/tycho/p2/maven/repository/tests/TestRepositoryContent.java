...
public final class TestRepositoryContent {
    ...
    public static final Set<String> BUNDLE_A_CONTENT_FILES = new HashSet<String>(Arrays.asList(new String[] {
    ...
    public static final Set<String> BUNDLE_B_CONTENT_FILES = new HashSet<String>(Arrays.asList(new String[] {
