...
import static org.eclipse.tycho.p2.maven.repository.tests.TestRepositoryContent.BUNDLE_A_CANONICAL_MD5;
...
public abstract class CompositeArtifactProviderTestBase<T extends IRawArtifactProvider> {
    ...
    public void testGetCanonicalRawArtifact() throws Exception {
        ...
        assertThat(testSink.md5AsHex(), is(BUNDLE_A_CANONICAL_MD5)); // raw artifacts are never processed -> files should be identical
    }
