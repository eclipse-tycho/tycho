...
public class RepositoryArtifactProviderTest extends CompositeArtifactProviderTestBase<IRawArtifactProvider> {
    ...
    @Override
    IRawArtifactProvider createCompositeArtifactProvider(URI... repositoryURLs) throws Exception {
    ...
    public void testGetNonExistingArtifact() {
        IStatus result = subject.getArtifact(NOT_CONTAINED_ARTIFACT_KEY, dataSink, null);
    ...
    public void testGetNonExistingRawArtifact() {
        IStatus result = subject.getRawArtifact(canonicalDescriptorFor(NOT_CONTAINED_ARTIFACT_KEY), dataSink, null);
    ...
    public void testErrorWhileGettingArtifact() throws Exception {
        ...
        IStatus result = subject.getArtifact(BUNDLE_A_KEY, dataSink, null);
    ...
    public void testErrorWhileGettingRawArtifact() throws Exception {
        ...
        IStatus result = subject.getRawArtifact(canonicalDescriptorFor(BUNDLE_A_KEY), dataSink, null);
