...
public interface ReactorRepositoryManager extends ReactorRepositoryManagerFacade {
     ...
     */
    PublishingRepository getPublishingRepository(ReactorProjectId project);
     ...
     *            a project in the reactor.
     */
    PublishingRepository getPublishingRepositoryForArtifactWriting(ReactorProjectId project,
