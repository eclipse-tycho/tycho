...
public class StreamRawArtifactSink extends StreamArtifactSink implements IRawArtifactSink {

    private IArtifactDescriptor requestedDescriptor;

    // TODO construct via factory
    public StreamRawArtifactSink(IArtifactDescriptor requestedDescriptor, OutputStream destination) {
