...
public class GAVArtifactDescriptorBase extends ArtifactDescriptor {
    ...
    protected final void setMavenCoordinateProperties() {
        ...
        putOrRemoveOnNull(properties, coordinates.getClassifier(), RepositoryLayoutHelper.PROP_CLASSIFIER);
        putOrRemoveOnNull(properties, coordinates.getExtension(), RepositoryLayoutHelper.PROP_EXTENSION);
    }

    private static void putOrRemoveOnNull(Map<String, String> properties, String value, String key) {
        if (value == null) {
