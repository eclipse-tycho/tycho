...
public class SourceBundlesGenerationTest extends AbstractTychoIntegrationTest {

    @Test
    public void testSourceBundlesGenerationTest() throws Exception {
        Verifier verifier = getVerifier("/sourceBundle.sourceGeneration", false);
        verifier.executeGoal("install");
        verifier.verifyErrorFreeLog();
        assertTargetDirContainsGeneratedSources(verifier);
    }
