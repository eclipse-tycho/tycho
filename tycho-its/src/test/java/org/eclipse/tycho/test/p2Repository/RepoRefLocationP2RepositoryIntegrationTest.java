...
public class RepoRefLocationP2RepositoryIntegrationTest extends AbstractTychoIntegrationTest {
    ...
    public void testRefLocation() throws Exception {
        ...
        File contentxml = new File(repository, "content.xml.xz");
        ...
        ReadXmlResult result = new MetadataIO().readXML(new FileInputStream(contentxml));
        assertThat(result.getUnits(), hasSize(20));
    }
