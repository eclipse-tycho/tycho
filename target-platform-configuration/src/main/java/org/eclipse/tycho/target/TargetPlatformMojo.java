...
public class TargetPlatformMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        if (usesLegacyTargetPlatform(project)) {
            return;
        }
    ...
    private static boolean usesLegacyTargetPlatform(MavenProject project) {
        return !"p2".equals(TychoProjectUtils.getTargetPlatformConfiguration(project).getTargetPlatformResolver());
    }
