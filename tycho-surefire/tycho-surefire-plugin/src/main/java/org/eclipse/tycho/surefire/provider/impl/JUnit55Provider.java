...
@Component(role = TestFrameworkProvider.class, hint = "junit55")
public class JUnit55Provider extends AbstractJUnitProvider {

    private static final Version VERSION = Version.parseVersion("5.5.1");
    ...
    public List<Dependency> getRequiredBundles() {
        return singletonList(newDependency("org.eclipse.tycho", "org.eclipse.tycho.surefire.junit55"));
    }

    @Override
    protected VersionRange getJUnitVersionRange() {
        return new VersionRange("[5.5,5.6)");
    }
