...
public class BuildPropertiesReaderImpl implements BuildPropertiesParser, Disposable {

    private final Map<String, BuildProperties> cache = new HashMap<String, BuildProperties>();
