...
public class TargetPlatformArtifactResolver {
    ...
    /**
     * Resolves the target file artifact with the given coordinates, session and remote repositories
     * 
     * @param groupId
     * @param artifactId
     * @param version
     ...
     * @param classifier
     * @param session
     * @return an empty optional if no reactor project matches or an optional describing the local
     *         file of this target artifact in the reactor
     * @throws TargetResolveException
     */
