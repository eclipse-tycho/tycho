...
/**
 * {@link DefaultMavenBundleResolver} helps in gathering bundles that are living in P2 and maven world and
...
public class DefaultMavenBundleResolver implements MavenBundleResolver {
    ...
    @Inject
    public DefaultMavenBundleResolver(Provider<TychoProjectManager> projectManagerProvider,
                                      MavenDependenciesResolver dependenciesResolver) {
        this.projectManagerProvider = projectManagerProvider; // TODO: cycle! Refactor this
    ...
    public Optional<ResolvedArtifactKey> resolveMavenBundle(MavenProject project, MavenSession mavenSession,
        ...
        try {
            ...
            ArtifactKey artifactKey = projectManagerProvider.get().getArtifactKey(artifact);
