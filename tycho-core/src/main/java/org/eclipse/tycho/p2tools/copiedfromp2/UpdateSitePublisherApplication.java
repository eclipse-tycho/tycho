...
/**
 * <p>
 * This application generates meta-data/artifact repositories from a local update site. The
 * {@code -source <localdir>} parameter must specify the top-level directory containing the update site.
 * </p>
 */
