...
public class PomDependencyCollectorTest extends TychoPlexusTestCase {
    ...
    static ArtifactMock artifactWithClassifier(String classifier) throws Exception {
        return new ArtifactMock(new File(
                "src/test/resources/platformbuilder/pom-dependencies/org.eclipse.osgi_3.5.2.R35x_v20100126.jar"),
    ...
    static ArtifactMock existingMetadata() {
        return new ArtifactMock(
                new File("src/test/resources/platformbuilder/pom-dependencies/existing-p2-metadata.xml"), "groupId",
