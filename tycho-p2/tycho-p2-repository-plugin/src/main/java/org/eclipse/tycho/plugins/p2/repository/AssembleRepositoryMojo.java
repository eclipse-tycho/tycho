...
public class AssembleRepositoryMojo extends AbstractRepositoryMojo {
    ...
    private static final String CREATE_P2_INDEX_EMPTY = "empty";
    ...
    private void createP2IndexFile(File destination) throws MojoExecutionException {
        try {
            ...
            if (FALSE.toString().equalsIgnoreCase(createP2Index)) {
                return;
            } else if (CREATE_P2_INDEX_EMPTY.toString().equalsIgnoreCase(createP2Index)) {
                ...
                throw new MojoExecutionException(format("Unknown value for parameter createP2Index: \"%s\"",
                        createP2Index));
            }
        } catch (IOException e) {
