...
/**
 * <p>
 * Updates p2 repository metadata in <code>${project.build.directory}/repository</code>.
 * </p>
 * <p>
 * This can be used if some other mojo modifies the repository artifacts after assemble-repository
 * </p>
 * 
 */
@Mojo(name = "update-artifacts-metadata", defaultPhase = LifecyclePhase.PACKAGE, threadSafe = true)
        ...
        synchronized (LOCK) {
            try {
                ...
                if (!destination.isDirectory()) {
                    System.out.println("does not exits: " + destination);
                    return;
                }
                ...
                mirrorApp.xzCompress(destinationRepoDescriptor);
