...
public final class DirectorMojo extends AbstractProductMojo {
     ...
     * <ul>
     * <li><code>current</code> - for the version of the director application included in the
     * current Tycho version (default)</li>
     * <li><code>luna</code> - for the director application from Eclipse Luna (4.4). This version
     * still supports installations for MacOS with the legacy file system layout. Requires that the
     * <code>directorRuntime</code> parameter is set to <code>standalone</code>.</li>
     * </ul>
     */
    ...
    private DirectorRuntime getDirectorRuntime() throws MojoFailureException, MojoExecutionException {
        ...
        case internal:
            if (directorVersion != DirectorVersion.current) {
                getLog().warn(
