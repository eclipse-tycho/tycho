...
public class TarGzArchiver {
    ...
    private int getFileMode(File source) {
        ...
        int fileMode = FilePermissionHelper.toOctalFileMode(attrs.permissions());
        log.debug("file mode: " + Integer.toOctalString(fileMode));
        return fileMode;
    }
